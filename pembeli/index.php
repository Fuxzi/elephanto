...
if (!$data) {
    die("Query pembeli gagal: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="id">
...
<a class="btn" href="tambah.php">+ Tambah Pembeli</a> |
...
<table border="1" cellpadding="8" cellspacing="0">
    ...
    <?php $no = 1; ?>
        ...
        <td><?= $no++; ?></td>
            ...
            <td>
                <a class="btn btn-secondary" href="edit.php?id=<?= $row['id_pembeli']; ?>">Edit</a> |
                <a class="btn btn-danger" href="hapus.php?id=<?= $row['id_pembeli']; ?>" onclick="return confirm('Yakin hapus data ini?')">Hapus</a>
            </td>
        </tr>
        <?php } ?>
    <?php } else { ?>
        <tr>
            <td colspan="6">Belum ada data pembeli.</td>
        </tr>
    <?php } ?>
</table>
</div></div>
